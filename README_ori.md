...
- `AnchorDedupPress` ([source](kvpress/presses/anchor_dedup_press.py), [proposal](anchor_dedup.md)): protect positional anchors while penalizing locally redundant non-anchor keys.
